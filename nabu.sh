...
load_env_for_svc(){
  ...
  case "$svc" in
    openwebui)
      vars=(WEBUI_URL OLLAMA_BASE_URL OAUTH_PROVIDER_NAME OPENID_PROVIDER_URL OAUTH_CLIENT_ID OAUTH_CLIENT_SECRET OPENID_REDIRECT_URI OAUTH_SCOPES ENABLE_OAUTH_SIGNUP OAUTH_MERGE_ACCOUNTS_BY_EMAIL AUDIO_TTS_OPENAI_API_BASE_URL AUDIO_TTS_ENGINE AUDIO_TTS_MODEL AUDIO_TTS_VOICE AUDIO_TTS_OPENAI_API_KEY)
      ;;
